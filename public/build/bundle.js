...
/***/ function(module, exports, __webpack_require__) {
	...
	/* REACT HOT LOADER */ if (false) { (function () { var ReactHotAPI = require("C:\\LearnReact\\ReactRedux\\node_modules\\react-hot-api\\modules\\index.js"), RootInstanceProvider = require("C:\\LearnReact\\ReactRedux\\node_modules\\react-hot-loader\\RootInstanceProvider.js"), ReactMount = require("react/lib/ReactMount"), React = require("react"); module.makeHot = module.hot.data ? module.hot.data.makeHot : ReactHotAPI(function () { return RootInstanceProvider.getRootInstances(ReactMount); }, React); })(); } try { (function () {
	...
	var _CustomContent = __webpack_require__(183);
	...
	var attachElement = document.getElementById('customContentApp');
	
	(0, _reactDom.render)(_react2.default.createElement(
	    _reactRedux.Provider,
	    { store: store },
	    _react2.default.createElement(_CustomContent2.default, null)
	), attachElement);
	
	/* REACT HOT LOADER */ }).call(this); } finally { if (false) { (function () { var foundReactClasses = module.hot.data && module.hot.data.foundReactClasses || false; if (module.exports && module.makeHot) { var makeExportsHot = require("C:\\LearnReact\\ReactRedux\\node_modules\\react-hot-loader\\makeExportsHot.js"); if (makeExportsHot(module, require("react"))) { foundReactClasses = true; } var shouldAcceptModule = true && foundReactClasses; if (shouldAcceptModule) { module.hot.accept(function (err) { if (err) { console.error("Cannot not apply hot update to " + "index.jsx" + ": " + err.message); } }); } } module.hot.dispose(function (data) { data.makeHot = module.makeHot; data.foundReactClasses = foundReactClasses; }); })(); } }
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _customContentAction = __webpack_require__(184);
	
	var _OpenImage = __webpack_require__(186);
		...
		return {
			actions: {
				setJsonData: function setJsonData() {
					return dispatch((0, _customContentAction.setJsonData)());
				},
				openImageModal: function openImageModal(targetImageId, staticJsonData) {
					return dispatch((0, _customContentAction.openImageModal)(targetImageId, staticJsonData));
				},
				closeImageModal: function closeImageModal() {
					return dispatch((0, _customContentAction.closeImageModal)());
				},
				deleteImage: function deleteImage(elementId, staticDeleteData) {
					return dispatch((0, _customContentAction.deleteImage)(elementId, staticDeleteData));
				}
			}
		};
	}
	...
	var CustomContent = function (_Component) {
		...
		function CustomContent(props) {
			...
			var _this = _possibleConstructorReturn(this, (CustomContent.__proto__ || Object.getPrototypeOf(CustomContent)).call(this, props));
	
			_this.handleOpenClick = _this.handleOpenClick.bind(_this);
			_this.deleteImage = _this.deleteImage.bind(_this);
			_this.printImage = _this.printImage.bind(_this);
			return _this;
		}
		...
		_createClass(CustomContent, [{
			...
			value: function mouseEnterCallback() {
				var getElementId = this.id;
				var element = document.getElementById(getElementId);
				element.className += " " + "hover";
			}
		}, {
			key: 'mouseLeaveCallback',
			value: function mouseLeaveCallback() {
				var getElementId = this.id;
				var element = document.getElementById(getElementId);
			...
			value: function render() {
				...
				for (var key in imageContentFields) {
					imageContentHtml.push(_react2.default.createElement(
						'div',
						{ className: "col-md-3 col-sm-6 col-xs-12" + this.props.customContentReducerObj.deleteImage[imageContentFields[key]['id']], key: ++i },
						_react2.default.createElement(
							'div',
							{ className: 'imgClass ', key: ++i, id: "imgId_" + imageContentFields[key]['id'] },
							_react2.default.createElement('img', { src: imageContentFields[key]['imageLocation'], width: '100%' }),
							_react2.default.createElement(
								'div',
								{ className: 'overlay' },
								_react2.default.createElement(_OpenImage2.default, {
								...
								_react2.default.createElement(
									'a',
									{ id: "deleteImage_" + imageContentFields[key]['id'], onClick: this.deleteImage, className: 'expand' },
									'Delete'
								),
								_react2.default.createElement(
									'a',
									{ id: "printImage_" + imageContentFields[key]['id'], onClick: this.printImage, className: 'expand' },
									'Print'
								),
								_react2.default.createElement(
									'a',
									{ className: 'closeOverlay hidden' },
									'x'
								)
							)
						),
				...
				return _react2.default.createElement(
					'div',
					{ className: 'bottomSlideEffect effects clearfix' },
					imageContentHtml
				);
			}
		}]);
	...
	/* REACT HOT LOADER */ }).call(this); } finally { if (false) { (function () { var foundReactClasses = module.hot.data && module.hot.data.foundReactClasses || false; if (module.exports && module.makeHot) { var makeExportsHot = require("C:\\LearnReact\\ReactRedux\\node_modules\\react-hot-loader\\makeExportsHot.js"); if (makeExportsHot(module, require("react"))) { foundReactClasses = true; } var shouldAcceptModule = true && foundReactClasses; if (shouldAcceptModule) { module.hot.accept(function (err) { if (err) { console.error("Cannot not apply hot update to " + "CustomContent.js" + ": " + err.message); } }); } } module.hot.dispose(function (data) { data.makeHot = module.makeHot; data.foundReactClasses = foundReactClasses; }); })(); } }
...
/***/ function(module, exports, __webpack_require__) {
	...
	var customJsonData = __webpack_require__(185);
	...
	module.exports = {
	  ...
	  deleteImage: function deleteImage(deleteElementId, staticDeleteData) {
	    return {
	      type: 'DELETE_IMAGE',
	...
	/* REACT HOT LOADER */ }).call(this); } finally { if (false) { (function () { var foundReactClasses = module.hot.data && module.hot.data.foundReactClasses || false; if (module.exports && module.makeHot) { var makeExportsHot = require("C:\\LearnReact\\ReactRedux\\node_modules\\react-hot-loader\\makeExportsHot.js"); if (makeExportsHot(module, require("react"))) { foundReactClasses = true; } var shouldAcceptModule = true && foundReactClasses; if (shouldAcceptModule) { module.hot.accept(function (err) { if (err) { console.error("Cannot not apply hot update to " + "customContentAction.js" + ": " + err.message); } }); } } module.hot.dispose(function (data) { data.makeHot = module.makeHot; data.foundReactClasses = foundReactClasses; }); })(); } }
...
/***/ function(module, exports) {
	...
	[
	    {
	      "id": "1",
	      "imageLocation": "/img/image_1.jpg",
	      "imageText" : "A ROAD TO DESTINY IN BETWEEN THE DISPLEASURES"
	    }, 
	    {
	      "id": "2",
	      "imageLocation": "/img/image_2.jpg",
	      "imageText" : "A RIVER TO FIND ITS WAY TO SOURCE"
	    },
	    {
	      "id": "3",
	      "imageLocation": "/img/image_3.jpg",
	      "imageText" : "A RAY OF HOPE IN BETWEEN MISERY"
	    },
	    {
	      "id": "4",
	      "imageLocation": "/img/image_4.jpg",
	      "imageText" : "I HAVE THE WORLD IN MY HAND. FACE ME !"
	    }
	]
...
/***/ function(module, exports, __webpack_require__) {
	...
	var OpenImage = function (_Component) {
		_inherits(OpenImage, _Component);
	
		function OpenImage(props) {
			_classCallCheck(this, OpenImage);
	
			return _possibleConstructorReturn(this, (OpenImage.__proto__ || Object.getPrototypeOf(OpenImage)).call(this, props));
		}
	
		_createClass(OpenImage, [{
			key: 'render',
			value: function render() {
				...
				return _react2.default.createElement(
					...
					_react2.default.createElement(
						'a',
						{ className: 'expand', onClick: this.props.handleOpenClick, id: this.props.id },
						'Open'
					),
					_react2.default.createElement(
						Modal,
						{ isOpen: this.props.imageModalVisibility[openId], className: 'ModalClass', overlayClassName: 'OverlayClass' },
						_react2.default.createElement(
							'div',
							...
							_react2.default.createElement(
								...
								_react2.default.createElement('img', { src: this.props.showImage[openId], height: '400px', width: '100%' }),
								_react2.default.createElement(
									'div',
									{ className: 'topPadding' },
									_react2.default.createElement(
										'button',
										{ className: 'btn btn-primary', onClick: this.props.onImageCloseClick },
										'Close'
									)
								)
							)
	...
	/* REACT HOT LOADER */ }).call(this); } finally { if (false) { (function () { var foundReactClasses = module.hot.data && module.hot.data.foundReactClasses || false; if (module.exports && module.makeHot) { var makeExportsHot = require("C:\\LearnReact\\ReactRedux\\node_modules\\react-hot-loader\\makeExportsHot.js"); if (makeExportsHot(module, require("react"))) { foundReactClasses = true; } var shouldAcceptModule = true && foundReactClasses; if (shouldAcceptModule) { module.hot.accept(function (err) { if (err) { console.error("Cannot not apply hot update to " + "OpenImage.js" + ": " + err.message); } }); } } module.hot.dispose(function (data) { data.makeHot = module.makeHot; data.foundReactClasses = foundReactClasses; }); })(); } }
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _customContentReducer = __webpack_require__(208);
	
	var _customContentReducer2 = _interopRequireDefault(_customContentReducer);
	
	function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }
	
	exports.default = (0, _redux.combineReducers)({
	    customContentReducer: _customContentReducer2.default
	});
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.default = customContentReducer;
	var initialState = {
	    contentData: [],
	    hoverClass: [],
	...
	/* REACT HOT LOADER */ }).call(this); } finally { if (false) { (function () { var foundReactClasses = module.hot.data && module.hot.data.foundReactClasses || false; if (module.exports && module.makeHot) { var makeExportsHot = require("C:\\LearnReact\\ReactRedux\\node_modules\\react-hot-loader\\makeExportsHot.js"); if (makeExportsHot(module, require("react"))) { foundReactClasses = true; } var shouldAcceptModule = true && foundReactClasses; if (shouldAcceptModule) { module.hot.accept(function (err) { if (err) { console.error("Cannot not apply hot update to " + "customContentReducer.js" + ": " + err.message); } }); } } module.hot.dispose(function (data) { data.makeHot = module.makeHot; data.foundReactClasses = foundReactClasses; }); })(); } }
